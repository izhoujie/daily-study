...
SELECT a.s_id,
MAX(CASE a.c_id WHEN '01' THEN a.s_score ELSE 0 END ) 语文, 
MAX(CASE a.c_id WHEN '02' THEN a.s_score ELSE 0 END ) 数学, 
MAX(CASE a.c_id WHEN '03' THEN a.s_score ELSE 0 END ) 英语, 
